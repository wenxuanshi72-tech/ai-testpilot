...
9. Verify one eligible same-batch correction, no provider retry, no Real/Mock fallback, and shared call/cost reservation for all remaining initial batches.
