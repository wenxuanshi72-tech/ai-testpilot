...
REVIEW_SCHEMA_VERSION = "test-case-review@1.0.0"
...
class ReviewSchemas:
    def __init__(self) -> None:
        self.review = self._load("schemas/reviews/v1/review_decision.schema.json")
        self.freeze = self._load("schemas/reviews/v1/freeze_request.schema.json")
