...
- `reproduction/v1/reproduction_observation.schema.json` (`reproduction-observation@1.0.0`)
- `reproduction/v1/reproduction_package_manifest.schema.json`
  (`bug-reproduction-package@1.0.0`)
